...
export const posts = [
    ...
    comments: [   
      {
        id: 2,
        author: "Christina",
        message: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti consequuntur inventore eum illo architecto id non, cum ipsam numquam recusandae! Nobis veniam vel vitae, blanditiis debitis qui voluptate enim nisi?",
        like: 1,
      ...
      },  
      {
        id: 3,
        author: "Chris",
        message: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis eaque illum facilis! Voluptatem ut qui non! Incidunt voluptas veritatis repellendus? Nobis veniam vel vitae, blanditiis debitis qui voluptate enim nisi?",
        like: 4,
        personalIcon: <BiUserCircle  size="80"/>
      },
      {
  ...
  },
  {
    ...
    text: "You can use lorem ipsum with text editors as well. If you’re using the sublime text editor, for example, here’s how to add lorem ipsum. Within the paragraph tags <p></p>,type lorem then click the tab key on your keyboard.",
    author: "Paulleth",
    image: "https://i.natgeofe.com/n/3ac79952-e41e-4726-b41c-b0e56f1dd38a/giraffe_01_2x3.JPG",
    comments: [
      {
        id: 3,
        author: "Christina",
